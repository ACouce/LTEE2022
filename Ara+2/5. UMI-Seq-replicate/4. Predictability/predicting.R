...
plot(gens, Rf[1:99,], xlim=c(1000,50000), ylim=c(0.02,0.8), type='o', col='white', cex.axis=1.35, cex.lab=1.3, xlab='generations', ylab='fraction of drivers')#, log='y')#,log='y')#, log='y')#, log='xy')
