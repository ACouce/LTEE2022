...
# .. prepare final table to plot by keeping non singletons (i.e., "multiple")
...
write.table(toplot,'Rtoanal.dat', sep = "\t") 	# change Rtable for Ttable and Ftable, and relabel file accordingly
...
# .. plot summary barplots (to extend the analyses beyond the 22 blocks shown, reset toplot by loading 'Rtoanal.dat')
